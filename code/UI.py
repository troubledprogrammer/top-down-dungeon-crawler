...
class UI(pg.sprite.Sprite):
    def __init__(self, player: Player):
        ...
        self.health_bar_inner_texture = _load_and_scale(ASSETS_PATH_UI + "heathbar_inner.png", HEATH_BAR_INNER_HEIGHT)
    ...
    def _update_dash_bar(self):
        ...
        self.dash_bar_inner = pg.transform.scale(self.dash_bar_inner_texture, (self.dash_bar_inner_width*ratio, DASH_BAR_INNER_HEIGHT))

    def _update_health_bar(self):
        ratio = self.player.health / PLAYER_MAX_HEALTH
        self.health_bar_inner = pg.transform.scale(self.health_bar_inner_texture, (self.health_bar_inner_width*ratio, HEATH_BAR_INNER_HEIGHT))
